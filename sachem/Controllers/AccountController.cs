...
namespace sachem.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.NomUsager, Email = model.Email };
                var result = await UserManager.CreateAsync(user, model.MP);
                if (result.Succeeded)
                {
        ...
        public ActionResult Register()
        {
            ...
            if (PAMIdentite.ObtenirTypeUsager(Session) != TypeUsagers.Aucun)
        ...
        public ActionResult Register(Personne personne, bool Autorisation)
        {
            ...
            //Si tous est ok...
            {
                ...
                else
                {
                    ...
                    PAMIdentite.EncrypterMPPersonne(ref EtudiantBD);
                    EtudiantBD.Autorisation = Autorisation;
