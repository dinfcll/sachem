...
namespace sachem.Controllers
{
    ...
    public class InscriptionController : Controller
    {
        ...
        private int HEURE_DEBUT = int.Parse(System.Configuration.ConfigurationManager.AppSettings.Get("HeureDebut"));
        private int HEURE_FIN = int.Parse(System.Configuration.ConfigurationManager.AppSettings.Get("HeureFin"));
