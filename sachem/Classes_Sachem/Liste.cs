...
namespace sachem.Classes_Sachem
{
    public class Liste
    {
        ...
        private List<SelectListItem> ListePersonne(int idSession, int idPers)
        {
        ...
        private List<SelectListItem> ListeCours(int cours = 0)
        {
        ...
        private List<SelectListItem> ListeCollege(int college = 0)
        {
        ...
        private List<SelectListItem> ListeStatutCours(int statut = 0)
        {
        ...
        private List<SelectListItem> ListeEnseignant(int enseignant = 0)
        {
        ...
        private List<SelectListItem> ListeSuperviseur(int superviseur = 0)
        {
        ...
        private List<SelectListItem> ListeTypeInscription(int typeInscription = 0)
        {
        ...
        private List<SelectListItem> ListeStatutInscriptionSansBrouillon(int statut = 0)
        {
